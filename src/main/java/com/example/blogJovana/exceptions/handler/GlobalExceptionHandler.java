...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleUserNotFoundException(UserNotFoundException ex) {
        ...
        ErrorResponse errorResponse = new ErrorResponse(errorMessage, HttpStatus.NOT_FOUND, LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleCategoryAlreadyExistsException(CategoryAlreadyExistsException ex) {
        ...
        ErrorResponse errorResponse = new ErrorResponse(errorMessage, HttpStatus.CONFLICT, LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleUnauthorizedActionException(UnauthorizedActionException ex) {
        ...
        ErrorResponse errorResponse = new ErrorResponse(errorMessage, HttpStatus.UNAUTHORIZED, LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleCommentNotFoundException(CommentNotFoundException ex) {
        String errorMessage = String.format("Post with id %s not found.", ex.getCommentId());
        ErrorResponse errorResponse = new ErrorResponse(errorMessage, HttpStatus.NOT_FOUND, LocalDateTime.now());
        return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
    }
}
